# Final Cleaned Monday List

This folder contains the conservative Monday trade list derived from the completed April 10 production run.
It applies an anti-chase overlay to remove extreme continuation names before trade execution.

## Files

- `buy_list.csv`: Generated artifact.
- `sell_list.csv`: Generated artifact.
