# Data Freshness Status — 2026-08-28
_generated 2026-08-28T02:34:26_
...
- **File-level**: max=2026-08-27  ·  stale=1bd  ·  limit=3bd  ·  ✅ OK
- **Column-level** (4 checks):
  - ✅ `close` — last non-null=2026-08-27  ·  stale=1bd  ·  limit=3bd
  - ✅ `rsi_14_daily` — last non-null=2026-08-27  ·  stale=1bd  ·  limit=3bd
  - ✅ `return_20d` — last non-null=2026-08-27  ·  stale=1bd  ·  limit=3bd
  - ✅ `volume_vs_20d` — last non-null=2026-08-27  ·  stale=1bd  ·  limit=3bd

### ✅ CS_ENGINE

- **Path**: `data/derived/compare_short_horizons.parquet`
- **File-level**: max=2026-08-28  ·  stale=0bd  ·  limit=3bd  ·  ✅ OK
...
- **Column-level** (7 checks):
  - ✅ `usdinr` — last non-null=2026-08-27  ·  stale=1bd  ·  limit=3bd
  - ✅ `brent` — last non-null=2026-08-27  ·  stale=1bd  ·  limit=5bd
  - ✅ `wti` — last non-null=2026-08-27  ·  stale=1bd  ·  limit=5bd
  - ✅ `us_10y` — last non-null=2026-08-27  ·  stale=1bd  ·  limit=5bd
  - ✅ `dxy` — last non-null=2026-08-27  ·  stale=1bd  ·  limit=5bd
  - ✅ `us_vix` — last non-null=2026-08-27  ·  stale=1bd  ·  limit=5bd
  - ✅ `spx` — last non-null=2026-08-27  ·  stale=1bd  ·  limit=5bd
...
- **Column-level** (3 checks):
  - ✅ `sector_5d_ret` — last non-null=2026-08-27  ·  stale=1bd  ·  limit=3bd
  - ✅ `sector_20d_ret` — last non-null=2026-08-27  ·  stale=1bd  ·  limit=3bd
  - ✅ `rs_20d` — last non-null=2026-08-27  ·  stale=1bd  ·  limit=3bd
...
- **File-level**: max=2026-08-27  ·  stale=1bd  ·  limit=10bd  ·  ✅ OK
...
- **Path**: `data/derived/stock_daily_facts_adjusted_2015plus.parquet`
- **File-level**: max=2026-08-27  ·  stale=0bd  ·  limit=0bd  ·  ✅ OK
