# Data Freshness Status — 2026-09-03
_generated 2026-09-03T20:57:11_
...
- **File-level**: max=2026-09-03  ·  stale=0bd  ·  limit=3bd  ·  ✅ OK
- **Column-level** (4 checks):
  - ✅ `close` — last non-null=2026-09-03  ·  stale=0bd  ·  limit=3bd
  - ✅ `rsi_14_daily` — last non-null=2026-09-03  ·  stale=0bd  ·  limit=3bd
  - ✅ `return_20d` — last non-null=2026-09-03  ·  stale=0bd  ·  limit=3bd
  - ✅ `volume_vs_20d` — last non-null=2026-09-03  ·  stale=0bd  ·  limit=3bd
...
- **Column-level** (7 checks):
  - ✅ `usdinr` — last non-null=2026-09-03  ·  stale=0bd  ·  limit=3bd
  - ✅ `brent` — last non-null=2026-09-03  ·  stale=0bd  ·  limit=5bd
  - ✅ `wti` — last non-null=2026-09-03  ·  stale=0bd  ·  limit=5bd
  - ✅ `us_10y` — last non-null=2026-09-03  ·  stale=0bd  ·  limit=5bd
  - ✅ `dxy` — last non-null=2026-09-03  ·  stale=0bd  ·  limit=5bd
  - ✅ `us_vix` — last non-null=2026-09-03  ·  stale=0bd  ·  limit=5bd
  - ✅ `spx` — last non-null=2026-09-03  ·  stale=0bd  ·  limit=5bd
...
- **Column-level** (3 checks):
  - ✅ `sector_5d_ret` — last non-null=2026-09-03  ·  stale=0bd  ·  limit=3bd
  - ✅ `sector_20d_ret` — last non-null=2026-09-03  ·  stale=0bd  ·  limit=3bd
  - ✅ `rs_20d` — last non-null=2026-09-03  ·  stale=0bd  ·  limit=3bd

### ✅ NEWS_EVENTS

- **Path**: `data/derived/news_event_features.parquet`
- **File-level**: max=2026-09-26  ·  stale=0bd  ·  limit=5bd  ·  ✅ OK

### ✅ ANNOUNCEMENTS

- **Path**: `data/events_full_history/normalized/stock_announcements.parquet`
- **File-level**: max=2026-08-27  ·  stale=5bd  ·  limit=10bd  ·  ✅ OK

### ✅ CORP_ACTIONS

- **Path**: `data/corporate_actions_full_history/normalized/stock_corporate_actions.parquet`
- **File-level**: max=2026-09-03  ·  stale=0bd  ·  limit=10bd  ·  ✅ OK

### ✅ PRICES_CONTINUITY

- **Path**: `data/derived/stock_daily_facts_adjusted_2015plus.parquet`
- **File-level**: max=2026-09-03  ·  stale=0bd  ·  limit=0bd  ·  ✅ OK
