# Locked Postfix Repeatability Check

This folder compares the two completed canonical production reruns after the locked-universe and validator fixes.
Open summary.json first, then run_comparison.csv, then repeatability_verdict.csv.

## Files

- `repeatability_verdict.csv`: Generated artifact.
- `run_comparison.csv`: Generated artifact.
