# Today Fresh Entry Intraday Calls

This folder contains the usable fresh-entry subset for trading on 2026-04-20.
The underlying champion model scored all stocks using official data through 2026-04-17.
A fresh-entry overlay removed stretched continuation names and data-quality anomalies from the scored top10.

## Files

- `intraday_calls_20260420.csv`: Generated artifact.
- `rejected_calls_20260420.csv`: Generated artifact.
