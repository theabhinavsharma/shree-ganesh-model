# Public Portfolio Signal Edge

This folder tests public-investor-style signals already present in the feature panel against 7D +5% outcomes.
Signals cover promoter/director buys, bulk-buy flow, and quarterly ownership changes by promoter/FII/DII/MF buckets.

## Files

- `public_signal_feature_results.csv`: Generated artifact.
